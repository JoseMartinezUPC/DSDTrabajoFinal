...
{
    public class ManagementServiceConsume : IManagementServiceConsume
    {
        ...
        public ManagementServiceConsume(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor, IOptions<AppSettings> settings)
        {
            ...
            _serviceURL = Environment.GetEnvironmentVariable("MANAGEMENT_SERVICE");
        }
